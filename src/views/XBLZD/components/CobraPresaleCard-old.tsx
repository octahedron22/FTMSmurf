...
const KongPresaleCard = () => {
  ...
  const TokenToRecive = getBalanceNumber((state.tokenAmount).times(1000000000000000000000000000000000000))
  ...
  return (
    <StyledFarmStakingCard>
      <CardBody>
        ...
        🎈🎈🐍 COBRA Presale is LIVE 🎈🎈
        </Heading>

        <Heading size="md" mb="24px">
        Get COBRA in ration 5 : 1  ( NO TAX! )
        </Heading>
        ...
        value = {value || ''}
        onChange = {(e) => {        
          const amount = new BigNumber(e.currentTarget.value) ;
          if (!amount.isNaN() && amount.gt(0))
          {
              tokenCount = KongFromBusdAmount(e.currentTarget.value);
