...
const ChangeCard = () => {
      ...
      try {
        const wasAdded = await provider.request({
          ...
          params: {
            type: 'ERC20',
            options: {
              address: '0x0841f5b9781FDEABea7a9ec8E4884FF05C439A3B',
              symbol: 'AXE',
              decimals: '18',
              image:
                'https://centaurus.network/images/egg/axemm.png',
              },
            },
          })
  ...
  return (
    <StyledFarmStakingCard>
      ...
      <Divider /> 
      <Text fontSize="17px" color="#33f72d" > {'>> \xa0'} {rajahBalanceFrom.toFixed(2)} {'\xa0 AXE left to buy <<'} </Text>

      <RowBetween>

      <CardImage
        src="images/egg/axe.png"
        alt="axe logo"
        width={130}
        height={130}
      />
...
{/* 
   ...
   */}
      ...
      <Text fontSize="20px">{axeBalance.toFixed(0)} AXE </Text>
